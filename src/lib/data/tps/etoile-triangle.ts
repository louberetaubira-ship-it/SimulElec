...
import { BASE_TESTS, L, POSTE_T1_OPTIONS, TRAFO_REF, liaisonsT1, netsT1 } from './common';
...
export const TP_ETOILE_TRIANGLE: TpDefinition = {
  ...
  // Quatre rails : depuis que les appareils portent leurs cotes constructeur,
  // cinq contacteurs et un transformateur de 122 px ne tiennent plus sur trois.
  rails: [150, 350, 550, 750],
  armoire: 920,
  slots: [
    { id: 'q1', label: 'Q1 · Disjoncteur moteur', key: 'motorcb', rail: 0, x: 46, rep: 'Q1' },
    { id: 'km1', label: 'KM1 · Ligne', key: 'kontakt', rail: 0, x: 114, rep: 'KM1' },
    { id: 'km2', label: 'KM2 · Étoile', key: 'kontakt', rail: 0, x: 182, rep: 'KM2' },
    { id: 'km3', label: 'KM3 · Triangle', key: 'kontakt', rail: 0, x: 250, rep: 'KM3' },
    { id: 'f1', label: 'F1 · Relais thermique', key: 'therm', rail: 0, x: 318, rep: 'F1' },
    { id: 'f2', label: 'F2 · Primaire T1', key: 'mcb2ph', rail: 1, x: 46, rep: 'F2' },
    { id: 't1', label: 'T1 · Transformateur Legrand 100 VA · 230-400 / 24-48 V', key: 'trafoleg', rail: 1, x: 104, rep: 'T1' },
    { id: 'f3', label: 'F3 · Secondaire 24 V · phase + neutre', key: 'mcb1pn', rail: 1, x: 230, rep: 'F3' },
    { id: 'ka1', label: 'KA1 · Bloc temporisé LADT2 (1 commun · 2 NF · 3 NO)', key: 'timer', rail: 1, x: 288, rep: 'KA1' },
    { id: 'kx2', label: 'KM2 · Bloc auxiliaire LADN11 (NF 21-22)', key: 'stopstart', rail: 2, x: 46, rep: 'KM2', auxDe: 'km2' },
    { id: 'kx3', label: 'KM3 · Bloc auxiliaire LADN11 (NF 21-22)', key: 'stopstart', rail: 2, x: 112, rep: 'KM3', auxDe: 'km3' },
    ...bornierX1(48, 3),
    ...bornierX2(282, 3),
  ],
  annexItems: [],
  ...
  mesures: [
    ...
    {
      id: 'renr', title: 'Résistance de l\'enroulement 1 au moteur (U1 – U2)', stage: 'horsTension',
      instrument: 'mm', dial: 'Ω', a: 'M.U1', b: 'M.U2', min: 1.5, max: 3, unit: 'Ω',
    },
    {
      // Côté MOTEUR de la borne, c'est-à-dire sur le câble. Côté armoire (.a), le
      // chemin passerait par KM1 et KM3, ouverts au repos : l'ohmmètre afficherait
      // OL, et l'élève conclurait à un enroulement coupé alors qu'il est sain.
      id: 'rbornier', title: 'Même enroulement contrôlé au bornier (X1:6 – X1:10, côté câble)', stage: 'horsTension',
      instrument: 'mm', dial: 'Ω', a: 'x1_6.b', b: 'x1_10.b', min: 1.5, max: 3, unit: 'Ω',
    },
    {
  ...
  faults: [
    { id: 'f3', title: 'F3 déclenché (court-circuit sur le 24 V)', symptom: 'Aucun voyant, aucune bobine ne colle, 0 V entre X2:1 et X2:6 alors que le secondaire de T1 est bien à 24 V.', fix: 'Chercher le défaut d\'isolement du circuit de commande, puis réarmer F3.', ouvre: 'f3', action: 'Chercher le défaut d\'isolement du 24 V, puis réarmer F3' },
    { id: 'a2', title: 'Fil A2 de la bobine KM1 desserré', symptom: 'KM1 vibre et retombe à l\'appui sur S2 : ni l\'étoile ni le triangle ne peuvent s\'établir.', fix: 'Resserrer A2 et refaire la continuité KM1 A2 – X2:6.', coupe: 'km1.A2>x2_6.a', action: 'Resserrer le fil sur A2 et contrôler la continuité jusqu\'au 0 V' },
    { id: 'l2', title: 'Phase L2 coupée entre F1:4 et X1:7', symptom: 'Le moteur ronfle et n\'accélère pas, courant déséquilibré, F1 déclenche après quelques secondes.', fix: 'Refaire la liaison F1:4 → X1:7 (conducteur V1), puis réarmer F1.', coupe: 'f1.4>x1_7.a', action: 'Refaire la liaison F1:4 → X1:7, puis réarmer F1' },
  ],
  quiz: [
