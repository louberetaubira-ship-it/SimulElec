/**
 * TP platine de service · CGM 2021 (EIP du lycée Mireille Grenet), partie 1, question 13 :
 * alimentation du cumulus piloté par un contact d'horloge programmable.
 *
 * Mode « câblage réel » de la question schéma du sujet numérique `cgm2021-eip` : le même
...
export const TP_CGM2021_Q13_CUMULUS: TpDefinition = {
  id: 'cgm2021-q13-cumulus',
  title: 'CGM 2021 · Alimentation du cumulus par contact d’horloge (câblage réel)',
  ...
  diplomas: ['bacpro'],
  summary:
    'Concours Général des Métiers MELEC 2021, partie 1 (EIP du lycée Mireille Grenet). Le cumulus des '
  ...
  schemaImage: {
    src: '/tp/cgm2021/q13-corrige.jpg',
