...
import { BASE_TESTS, L, TRAFO_REF, X1, liaisonsT1, netsT1 } from './common';
...
export const TP_POMPE_RELEVAGE: TpDefinition = {
  ...
  // Rails écartés : le coffret de flotteurs mordait la goulotte du rail suivant.
  rails: [150, 360, 620],
  armoire: 820,
  slots: [
    { id: 'q1', label: 'Q1 · Disjoncteur moteur', key: 'motorcb', rail: 0, x: 46, rep: 'Q1' },
    { id: 'km1', label: 'KM1 · Contacteur pompe', key: 'kontakt', rail: 0, x: 114, rep: 'KM1' },
    ...
    { id: 'ka1', label: 'KA1 · Relais de mémorisation (1-2 bobine · 3-4 contact NO)', key: 'timer', rail: 1, x: 288, rep: 'KA1' },
    ...X1(48),
    ...bornierX2(230),
  ...
  liaisons: [
    ...
    ...liaisonsT1({ retour: 'x2_9.a', terre: 'x1_5.a' }),
  ...
  faults: [
    { id: 's1', title: 'Contact NF de S1 (21-22) resté ouvert', symptom: 'Ni la marche forcée ni l\'automatique ne démarrent la pompe, alors que 24 V sont bien présents sur X2:1.', fix: 'Remplacer le bloc de contact NF de S1 et refaire la continuité X2:1 – X2:2.', ouvre: 'S1', action: 'Remplacer le bloc de contact du bouton d\'arrêt' },
    { id: 'a2', title: 'Fil A2 de la bobine KM1 desserré', symptom: 'KM1 vibre sans tenir dès que la demande arrive : la pompe démarre par à-coups.', fix: 'Resserrer A2 et refaire la continuité KM1 A2 – KA1:2 – X2:9.', coupe: 'km1.A2>ka1.2', action: 'Resserrer le fil sur A2 et contrôler la continuité jusqu\'au 0 V' },
    { id: 'l2', title: 'Phase L2 coupée entre F1:4 et X1:7', symptom: 'La pompe ronfle sans tourner, ne relève plus, courant anormal sur L1 et L3, F1 finit par déclencher.', fix: 'Refaire la liaison F1:4 → X1:7, puis réarmer F1.', coupe: 'f1.4>x1_7.a', action: 'Refaire la liaison F1:4 → X1:7, puis réarmer F1' },
  ],
  quiz: [
