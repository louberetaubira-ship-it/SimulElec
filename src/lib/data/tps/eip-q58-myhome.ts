/**
 * TP platine de service · sujet EIP, partie 3, question 58 :
...
export const TP_EIP_Q58_MYHOME: TpDefinition = {
  id: 'eip-q58-myhome',
  title: 'EIP · Installation MyHOME de l’EIP (câblage réel)',
  level: 'Bac Pro MELEC',
  family: 'ter',
  scene: 'ter',
  annex: 'local',
  ...
  uContinu: 27,
  summary:
    'Sujet EIP, partie 3 : gestion de l’espace d’innovation partagé en '
