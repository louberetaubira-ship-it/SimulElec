/**
 * TP platine de service · CGM 2021 (EIP du lycée Mireille Grenet), partie 4, question 67 :
...
export const TP_CGM2021_Q67_VIGIK: TpDefinition = {
  id: 'cgm2021-q67-vigik',
  title: 'CGM 2021 · Contrôle d’accès VIGIK de l’EIP (câblage réel)',
  ...
  uContinu: 12,
  summary:
    'Concours Général des Métiers MELEC 2021, partie 4 : contrôle d’accès de l’espace d’innovation '
  ...
  schemaImage: {
    src: '/tp/cgm2021/q67-corrige.jpg',
