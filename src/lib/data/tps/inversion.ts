...
export const TP_INVERSION: TpDefinition = {
  ...
  // Quatre rails : les blocs auxiliaires descendent sur le troisième, les
  // borniers sur le quatrième.
  rails: [150, 350, 550, 750],
  armoire: 920,
  slots: [
    { id: 'q1', label: 'Q1 · Disjoncteur moteur', key: 'motorcb', rail: 0, x: 46, rep: 'Q1' },
    { id: 'km1', label: 'KM1 · Marche avant', key: 'kontakt', rail: 0, x: 114, rep: 'KM1' },
    { id: 'km2', label: 'KM2 · Marche arrière', key: 'kontakt', rail: 0, x: 182, rep: 'KM2' },
    { id: 'f1', label: 'F1 · Relais thermique', key: 'therm', rail: 0, x: 250, rep: 'F1' },
    ...
    { id: 'kx1', label: 'KM1 · Bloc auxiliaire LADN11 (NF 21-22)', key: 'stopstart', rail: 1, x: 288, rep: 'KM1', auxDe: 'km1' },
    { id: 'kx2', label: 'KM2 · Bloc auxiliaire LADN11 (NF 21-22)', key: 'stopstart', rail: 2, x: 46, rep: 'KM2', auxDe: 'km2' },
    ...X1(52, 3),
    ...X2(238, 7, 3, { subs: ['S1', 'S1/S2', 'S2 av', 'S3 ar', 'H1', 'H2', '0V'] }),
    S3_BOX,
  ],
  annexItems: [],
  recvItems: [],
  ...
  faults: [
    { id: 'a2', title: 'Fil A2 de la bobine KM1 desserré', symptom: 'KM1 vibre et ne tient pas à l\'appui sur S2 ; la marche arrière se comporte normalement.', fix: 'Resserrer A2 et refaire la continuité KM1 A2 – X2:7.', coupe: 'km1.A2>x2_7.a', action: 'Resserrer le fil sur A2 et contrôler la continuité jusqu\'au 0 V' },
    { id: 'x2', title: 'Fil kx2:22 → KM1 A1 débranché (sortie du verrouillage)', symptom: 'Rien ne se passe à l\'appui sur S2, alors que les 24 V sont bien présents sur X2:3 et sur le contact NF de KM2.', fix: 'Reconnecter la sortie 22 du bloc auxiliaire de KM2 sur la borne A1 de KM1.', coupe: 'kx2.22>km1.A1', action: 'Reconnecter la sortie 22 du bloc auxiliaire de KM2 sur la borne A1 de KM1' },
    { id: 'l2', title: 'Phase L2 coupée entre F1:4 et X1:7', symptom: 'Le moteur ronfle sans démarrer dans les deux sens, courant anormal sur L1 et L3, F1 finit par déclencher.', fix: 'Refaire la liaison F1:4 → X1:7, puis réarmer F1.', coupe: 'f1.4>x1_7.a', action: 'Refaire la liaison F1:4 → X1:7, puis réarmer F1' },
  ],
  quiz: [
